...
bucse-mount: bucse-mount.o destinations/dest_local.o destinations/dest_ssh.o encryption/encr_none.o encryption/encr_aes.o dynarray.o filesystem.o actions.o
	$(CC) -o bucse-mount $(CFLAGS) bucse-mount.o destinations/dest_local.o destinations/dest_ssh.o encryption/encr_none.o encryption/encr_aes.o dynarray.o filesystem.o actions.o $(LIBS)

bucse-mount.o: bucse-mount.c destinations/dest.h encryption/encr.h dynarray.h filesystem.h actions.h
...
clean:
	-rm -f bucse-mount bucse-mount.o destinations/dest_local.o destinations/dest_ssh.o encryption/encr_none.o encryption/encr_aes.o dynarray.o filesystem.o actions.o
